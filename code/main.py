...
tf.app.flags.DEFINE_integer("save_every", 10, "How many iterations to do per save.")
tf.app.flags.DEFINE_integer("eval_every", 751, "How many iterations to do per calculating loss/f1/em on dev set. Warning: this is fairly time-consuming so don't do it too often.")
