...
tf.app.flags.DEFINE_integer("batch_size", 300, "Batch size to use")
...
tf.app.flags.DEFINE_integer("eval_every", 750, "How many iterations to do per calculating loss/f1/em on dev set. Warning: this is fairly time-consuming so don't do it too often.")
